...
if (isset($_GET['txtID'])) {
    ...
    $sentencia = $conexion->prepare("SELECT * FROM `papelera` WHERE id = :id");
...
if ($_POST) {
    ...
    $nombreArchivo_foto_con_ruta = "../../imgPapelera/" . $nombreArchivo_foto;
    $tmp_foto = $_FILES["foto"]['tmp_name']; 
    if ($tmp_foto !=''){
    move_uploaded_file($tmp_foto, $nombreArchivo_foto_con_ruta);
    }   
    $sentencia = $conexion->prepare("UPDATE `papelera` 
